...
pub fn build(b: *std.Build) void {
    ...
    mod.link_libc = true;
    mod.addIncludePath(b.path("third-party/ctoon"));
    mod.addCSourceFile(.{ .file = b.path("src/ctoon.c") });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "spline" is the name you will use in your source code to
                // import this module (e.g. `@import("spline")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "spline", .module = mod },
            },
        }),
    });
